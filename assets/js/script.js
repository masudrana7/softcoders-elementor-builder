...
(function ($) {
	jQuery(document).ready(function($){
		...
		// Image upload field
		$("body").on('click', '.softcoders_upload_image', function(event) {
			var btnClicked = $(this);
			alert("hello");
			var custom_uploader = wp.media({
				...
				btnClicked.closest(".softcoders_metabox_image").find(".custom_upload_image").val(attachment.id).trigger('change');
				btnClicked.closest(".softcoders_metabox_image").find(".custom_preview_image").attr("src", attachment.url).show();
				btnClicked.closest(".softcoders_metabox_image").find(".softcoders_remove_image_wrap").show();
