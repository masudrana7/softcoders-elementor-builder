...
add_action( 'elementor/element/section/section_advanced/after_section_end', 'SoftCoders_RegisterSectionControls', 10, 2 );
function SoftCoders_RegisterSectionControls( $element, $sectionId ) {
