...
if( !class_exists( 'softcoders_Postmeta_Fields' ) ){
	class softcoders_Postmeta_Fields {
		...
		public function image( $key, $field, $default, $class ){
			...
			echo '
			<div class="softcoders_metabox_image">
				...
				<input class="softcoders_upload_image upload_button_'. esc_attr( $key ) .' button-primary" type="button" value="' . esc_attr__( 'Choose Image', 'rt-framework' ). '" />
				<div class="softcoders_remove_image_wrap" style="'. esc_attr( $disstyle ) .'"><a href="#" class="softcoders_remove_image button" >' . esc_html__( 'Remove Image', 'rt-framework' ). '</a></div>
			</div>
			';
		}
		public function gallery( $key, $field, $default, $class ){
			...
			echo '
			<div class="softcoders_metabox_gallery">
				<input name="'. esc_attr( $key ) .'" type="hidden" class="custom_upload_image" value="'. esc_attr( $default ) .'" />
				<div class="custom_preview_images">' . $img_html . '</div>
				<div class="softcoders_metabox_gallery_buttons">
					<input class="softcoders_upload_gallery upload_button_'. esc_attr( $key ) .' button-primary" type="button" value="' . esc_attr__( 'Add/Edit Gallery Images', 'rt-framework' ). '" />
					<a href="#" style="'. esc_attr( $disstyle ) .'" class="softcoders_remove_gallery button" >' . esc_html__( 'Remove All Images', 'rt-framework' ). '</a>
				</div>
			</div>
			';
		}
		public function file( $key, $field, $default, $class ){
			...
			echo '
			<div class="softcoders_metabox_file">
				<input name="'. esc_attr( $key ) .'" type="hidden" class="custom_upload_file" value="'. esc_attr( $default ) .'" />
				<input class="softcoders_upload_file upload_button_'. esc_attr( $key ) .' button-primary" type="button" value="' . esc_attr__( 'Choose File', 'rt-framework' ). '" />
				<div class="softcoders_remove_file_wrap" style="'. esc_attr( $disstyle ) .'"><a href="#" class="softcoders_remove_file button" >' . esc_html__( 'Remove File', 'rt-framework' ). '</a></div>
