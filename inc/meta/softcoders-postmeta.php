...
require_once softcoderselements_DIR . '/inc/meta/softcoders-postmeta-fields.php';

if( !class_exists( 'softcoders_Postmeta' ) ){

	class softcoders_Postmeta {
		protected static $instance = null;
		public  $version          = softcoderselements_VER;
		private $fields_obj       = null;
		public  $base_url         = null;
		private $metaboxes        = array();
		private $metabox_fields   = array();
		private $nonce_action     = 'softcoders_metabox_nonce';
		private $nonce_field      = 'softcoders_metabox_nonce_secret';
		private function __construct() {
			$this->fields_obj = new softcoders_Postmeta_Fields();
			$this->base_url   = softcoderselements_URL;
		...
		public function add_meta_box( $id, $title, $post_types, $callback = '', $context = '', $priority = '', $fields = '' ) {
			...
			$fields = apply_filters( 'softcoders_postmeta_field_' . $id, $fields );
			$metaboxes = array(
				'title'         => $title,
				'callback'      => $callback,
			...
			$this->metaboxes[$id] = apply_filters( 'softcoders_metabox_' . $id, $metaboxes );
...
softcoders_Postmeta::getInstance();